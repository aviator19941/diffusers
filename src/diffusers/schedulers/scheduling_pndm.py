...
class PNDMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def _get_prev_sample(self, sample, timestep, prev_timestep, model_output):
        ...
        # prev_sample -> x_(t−δ)
        alpha_prod_t = self.alphas_cumprod.index_select(0, timestep).data[0]
        alpha_prod_t_prev = torch.where(prev_timestep >= 0, torch.index_select(self.alphas_cumprod, 0, abs(prev_timestep)).data[0], self.final_alpha_cumprod).data[0]
